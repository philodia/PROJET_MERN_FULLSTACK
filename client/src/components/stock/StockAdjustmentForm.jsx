// frontend/src/components/stock/StockAdjustmentForm.jsx
    ...
    >
      {({ errors, touched, isSubmitting, values, setFieldValue }) => (
        <Form noValidate className="stock-adjustment-form">
          ...
          <BootstrapForm.Group className="mb-3" controlId="productInfoSA"> {/* ID unique */}
          ...
          <Row>
            <BootstrapForm.Group as={Col} md={6} className="mb-3" controlId="adjustmentDateSA"> {/* ID unique */}
            ...
            <BootstrapForm.Group as={Col} md={6} className="mb-3" controlId="adjustmentTypeSA"> {/* ID unique */}
          ...
          {values.adjustmentType === 'IN' || values.adjustmentType === 'OUT' ? (
            <BootstrapForm.Group className="mb-3" controlId="quantitySA"> {/* ID unique */}
              <BootstrapForm.Label>
          ...
          {values.adjustmentType === 'CORRECTION' && (
            <BootstrapForm.Group className="mb-3" controlId="newStockQuantitySA"> {/* ID unique */}
          ...
          <BootstrapForm.Group className="mb-3" controlId="reasonSA"> {/* ID unique */}
